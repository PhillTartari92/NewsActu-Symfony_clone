...
class RegisterFormType extends AbstractType
{
    ...
    #Nous avons déclaré une propriété de class, car la fonction buildForm() ne preut prendre aucune injection de dépendance.
    private $security;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder 
            ...
            ->add('submit', SubmitType::class, [
                ...
                'validate' => false,
                'attr' => [
                    'class' => 'd-block col-4 my-3 mx-auto btn btn-warning'
                ]
            ])
        ;
    }
