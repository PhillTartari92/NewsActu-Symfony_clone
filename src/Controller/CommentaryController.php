...
class CommentaryController extends AbstractController
{
    ...
    /**
     * 1ère Façon ==>
     *        Inconvénient : C'est verbeux. 
     *                       Les paramètres attendus de la route pour faire un redirectToRoute() peuvent ne pas être accessibles.
     * 
     *        Avantage     : La redirection sera STATIQUE, tous les utilisateurs seront au meme endroit.
     * 
     ...
     *                
     *            Avantage : La redirection devient DYNAMIQUE. ( elle changera en fonction de la provenance de la requete ) 
     */ 
